...
export default class MahjongTagHandler extends Ubb.RecursiveTagHandler {
    ...
    getCartoonUrl(mahjongId: string) {
        switch (mahjongId) {
            case "018": case "049": case "096": return `http://www.cc98.org/static/images/mahjong/carton2017/${mahjongId}.gif`;
    ...
    getFaceUrl(mahjongId: string) {
        switch (mahjongId) {
            case "004": case "009": case "056": case "061": case "062": case "087": case "115": case "120": case "137": case "168": case "169": case "175": case "206": return `http://www.cc98.org/static/images/mahjong/face2017/${mahjongId}.gif`
